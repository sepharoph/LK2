        ...
        public override LootPack Loot
        {
            get
            {
                return new LootPack(new LootPackEntry[]
                {
                    ...
                    new LootPackEntry(4, typeof(script.item.BattleShield), "15d10+225", 1, 1, 1),
                    new LootPackEntry(4, typeof(script.item.ChestGuard), "15d10+225", 1, 1, 1),
                    new LootPackEntry(4, typeof(script.item.LargeAxe), "15d10+225", 1, 1, 1),
                    new LootPackEntry(4, typeof(script.item.FullHelmet), "15d10+225", 1, 1, 1),
                    new LootPackEntry(4, typeof(script.item.BattleArmor), "15d10+225", 1, 1, 1),
