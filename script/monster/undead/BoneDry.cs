        ...
        public override LootPack Loot
        {
            get
            {
                return new LootPack(new LootPackEntry[]
                {
                    ...
                    new LootPackEntry(1.0, typeof(script.item.Rapier), "10d22+250", 40, 1, 1),
                    new LootPackEntry(1.0, typeof(script.item.SpikedClub), "10d22+250", 40, 1, 1),
                    new LootPackEntry(1.0, typeof(script.item.Cape), "10d22+250", 40, 1, 1),
                    new LootPackEntry(1.0, typeof(script.item.SmallAxe), "10d22+250", 40, 1, 1),
