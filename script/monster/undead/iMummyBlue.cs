        ...
        public override LootPack Loot
        {
            get
            {
                return new LootPack(new LootPackEntry[]
                {
                    ...
                    new LootPackEntry(0.1, typeof(script.item.Crook), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.LargeAxe), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.LightningWallBook), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.Skewer), "10d22+250", 40, 1, 1),
