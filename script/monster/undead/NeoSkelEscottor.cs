...
namespace LKCamelot.script.monster
{
    public class NeoSkelEscottor : Monster
    {
        ...
        public override int XP { get { return 515; } }
        ...
        public override LootPack Loot
        {
            get
            {
                return new LootPack(new LootPackEntry[]
                {
                    ...
                    new LootPackEntry(5.0, typeof(script.item.OneEdgedAxe), "10d22+250", 40, 1, 1),
                    new LootPackEntry(5.0, typeof(script.item.Mask), "10d22+250", 40, 1, 1),
                    new LootPackEntry(5.0, typeof(script.item.SquareShield), "10d22+250", 40, 1, 1),
