        ...
        public override LootPack Loot
        {
            get
            {
                return new LootPack(new LootPackEntry[]
                {
                    ...
                    new LootPackEntry(0.05, typeof(script.item.FireShotBook), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.05, typeof(script.item.ExecutionBook), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.05, typeof(script.item.LongStaff), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.05, typeof(script.item.Harpoon), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.075, typeof(script.item.ThunderStormBook), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.BattleArmor), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.LargeAxe), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.FullHelmet), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.Claymore), "10d22+250", 40, 1, 1),
