        ...
        public override LootPack Loot
        {
            get
            {
                return new LootPack(new LootPackEntry[]
                {
                    ...
                    new LootPackEntry(1.0, typeof(script.item.AssasinBook), "10d22+250", 40, 1, 1),
                    new LootPackEntry(1.0, typeof(script.item.FireHawkBook), "10d22+250", 40, 1, 1),
                    new LootPackEntry(1.5, typeof(script.item.FireShotBook), "10d22+250", 40, 1, 1),
                    new LootPackEntry(5, typeof(script.item.DemonDeathBook), "10d22+250", 40, 1, 1),
