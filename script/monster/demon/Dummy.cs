        ...
        public override LootPack Loot
        {
            get
            {
                return new LootPack(new LootPackEntry[]
                {
                    ...
                    new LootPackEntry(0.1, typeof(script.item.EnamelLeather), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.CoatingShield), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.BroadAxe), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.ChestGuard), "10d22+250", 40, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.FieldCap), "10d22+250", 40, 1, 1),
