        ...
        public override LootPack Loot
        {
            get
            {
                return new LootPack(new LootPackEntry[]
                {
                    ...
                    new LootPackEntry(1.5, typeof(script.item.DeadlyBoomBook), "15d10+225", 1, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.KVSword), "15d10+225", 1, 1, 1),
                    new LootPackEntry(0.1, typeof(script.item.FSofdk), "15d10+225", 1, 1, 1),
                    new LootPackEntry(3, typeof(script.item.RevelationBook), "15d10+225", 1, 1, 1),
                    new LootPackEntry(2, typeof(script.item.DemonDeathBook), "15d10+225", 1, 1, 1),
