...
{
    public class RingOfTheStrong : BaseArmor
    {
        public override string Name { get { return "RING OF THE STRONG"; } }
        ...
        public RingOfTheStrong()
            : base(1)
        {
        }

        public RingOfTheStrong(Serial serial)
            : base(serial)
        {
        }
    }
