...
Leveling this spell increases distance of pickup from, distance includes (w/ 12 books) 
9 squares, current + 8(at 99:12 current + surrounding 40 cells/squares
(that means 3 squares from the caster in every direction would have loot picked up) */
